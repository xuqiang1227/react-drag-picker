...
var _isNull = __webpack_require__(38);
...
var _each = __webpack_require__(93);

var _each2 = _interopRequireDefault(_each);

var _noop = __webpack_require__(103);
...
var DragPicker = function (_React$PureComponent) {
  _inherits(DragPicker, _React$PureComponent);

  function DragPicker() {
    _classCallCheck(this, DragPicker);

    var _this = _possibleConstructorReturn(this, (DragPicker.__proto__ || Object.getPrototypeOf(DragPicker)).apply(this, arguments));
  ...
  _createClass(DragPicker, [{
    ...
    value: function componentDidUpdate() {
      if (this.state.mouseDown && !(0, _isNull2.default)(this.state.selectionBox)) {
    ...
    value: function onMouseUp(e) {
      ...
      window.document.removeEventListener('mousemove', function (e) {
      ...
      this.props.onChange && this.props.onChange.call(null, (0, _keys2.default)(this.selectedChildren));
    }
  }, {
    key: 'onMouseMove',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: this.props.className || '', ref: 'selectionBox', onMouseDown: function onMouseDown(e) {
    ...
    value: function renderItem() {
      ...
      return _react2.default.Children.map(this.props.children, function (child) {
        var tmpKey = (0, _isNull2.default)(child.key) ? index++ : child.key;
        var isSelected = (0, _has2.default)(_this5.selectedChildren, tmpKey);
        debugger;
        return _react2.default.cloneElement(child, {
          ...
          onClickCapture: function onClickCapture(e) {
            if ((e.ctrlKey || e.altKey || e.shiftKey) && _this5.props.enabled) {
              e.preventDefault();
              e.stopPropagation();
              _this5.selectItem(tmpKey, !(0, _has2.default)(_this5.selectedChildren, tmpKey));
            }
          }
        });
      });
    ...
    value: function renderPickerBox() {
      if (!this.state.mouseDown || (0, _isNull2.default)(this.state.endPoint) || (0, _isNull2.default)(this.state.startPoint)) {
        return null;
      }
    ...
    key: 'selectItem',
    value: function selectItem(key, isSelected) {
      if (isSelected) {
        this.selectedChildren[key] = isSelected;
      } else {
        delete this.selectedChildren[key];
      }
      this.props.onChange.call(null, (0, _keys2.default)(this.selectedChildren));
      this.forceUpdate();
    }
  }, {
    key: 'selectAll',
    value: function selectAll() {
      ...
      (0, _each2.default)(this.refs, function (ref, key) {
        if (key !== 'selectionBox') {
    ...
    key: 'boxIntersects',
    value: function boxIntersects(boxA, boxB) {
    ...
    value: function updateCollidingChildren(selectionBox) {
      ...
      (0, _each2.default)(this.refs, function (ref, key) {
        if (key !== 'selectionBox') {
          ...
          if (_this7.boxIntersects(selectionBox, tmpBox)) {
            _this7.selectedChildren[key] = true;
          } else {
            if (!_this7.state.appendMode) {
              delete _this7.selectedChildren[key];
            }
          }
        }
      });
    ...
    key: 'calculateSelectionBox',
    value: function calculateSelectionBox(startPoint, endPoint) {
      if (!this.state.mouseDown || (0, _isNull2.default)(endPoint) || (0, _isNull2.default)(startPoint)) {
        return null;
      }
      var parentNode = this.refs.selectionBox.parentNode;
...
var memoize = __webpack_require__(62);
...
var arrayEach = __webpack_require__(95),
    ...
    castFunction = __webpack_require__(101),
    isArray = __webpack_require__(2);
...
*/
var aa=__webpack_require__(10),l=__webpack_require__(27),B=__webpack_require__(12),C=__webpack_require__(1),ba=__webpack_require__(28),da=__webpack_require__(29),ea=__webpack_require__(30),fa=__webpack_require__(31),ia=__webpack_require__(32),D=__webpack_require__(33);
